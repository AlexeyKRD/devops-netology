...
CREATE ROLE sa;
ALTER ROLE sa WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'md5f45731e3d39a1b2330bbf93e9b3de59e';
...
--
-- Name: sa; Type: DATABASE; Schema: -; Owner: sa
--

CREATE DATABASE sa WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.utf8' LC_CTYPE = 'en_US.utf8';


ALTER DATABASE sa OWNER TO sa;
